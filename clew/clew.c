...
#include "clew.h"
    ...
    #define CLEW_DYNLIB_OPEN    LoadLibraryW
...
PRNCLENQUEUERELEASEGLOBJECTS        __clewEnqueueReleaseGLObjects       = NULL;
...
int clewInit(const wchar_t* path)
{
    ...
    __clewCreateSubBuffer               = (PFNCLCREATESUBBUFFER             )CLEW_DYNLIB_IMPORT(module, "clCreateSubBuffer"); // !!! CHECK THIS !!!
    __clewCreateImage                   = (PFNCLCREATEIMAGE                 )CLEW_DYNLIB_IMPORT(module, "clCreateImage");     // !!! CHECK THIS !!!
    ...
    __clewEnqueueReleaseGLObjects       = (PRNCLENQUEUERELEASEGLOBJECTS     )CLEW_DYNLIB_IMPORT(module, "clEnqueueReleaseGLObjects");
